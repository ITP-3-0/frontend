...
export default function AgentDashboard() {
    ...
    return (
        <div className="container mx-auto py-8 px-20 mt-20">
            <Toaster />
            <div className="mb-8">
                                ...
                                <Card key={ticket._id} className="hover:shadow-lg transition-shadow">
                                    ...
                                    <CardContent>
                                        ...
                                        <div className="flex justify-between items-center">
                                            <Badge
                                                variant={
                                                    ticket.status === "resolved" ? "success" : ticket.status === "in_progress" ? "warning" : "default"
                                                }
                                            >
                                                {ticket.status}
                                            </Badge>
                                            <div className="space-x-2">
                                                {ticket.status === "resolved" && (
                                                    <Button variant="destructive" onClick={() => deleteTicket(ticket._id)}>
                                                        Delete
                                                    </Button>
                                                )}
            ...
            {selectedTicket && (
                <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4">
                    <div className="bg-white rounded-lg p-6 max-w-2xl w-full max-h-[90vh] overflow-y-auto mt-20">
